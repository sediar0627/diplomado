...
export const gradientBgPurplePink = `bg-gradient-to-b from-gray-200 via-gray-400 to-gray-600`;
export const gradientBgDark = `${gradientBgBase} from-slate-700 via-slate-900 to-slate-800`;
export const gradientBgPinkRed = `${gradientBgBase} from-pink-400 via-red-500 to-yellow-500`;
export const gradientBgGray = `bg-gradient-to-b from-gray-200 via-gray-400 to-gray-600`;
